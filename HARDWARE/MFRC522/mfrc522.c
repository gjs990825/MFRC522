...
char *GetStatusCodeName(StatusCode code	///< One of the StatusCode enums.
	...
	switch (code) {
		case STATUS_OK:				return (char *)("Success.");
		case STATUS_ERROR:			return (char *)("Error in communication.");
		case STATUS_COLLISION:		return (char *)("Collission detected.");
		case STATUS_TIMEOUT:		return (char *)("Timeout in communication.");
		case STATUS_NO_ROOM:		return (char *)("A buffer is not big enough.");
		case STATUS_INTERNAL_ERROR:	return (char *)("Internal error in the code. Should not happen.");
		case STATUS_INVALID:		return (char *)("Invalid argument.");
		case STATUS_CRC_WRONG:		return (char *)("The CRC_A does not match.");
		case STATUS_MIFARE_NACK:	return (char *)("A MIFARE PICC responded with NAK.");
...
char *PICC_GetTypeName(PICC_Type piccType	///< One of the PICC_Type enums.
	...
	switch (piccType) {
		case PICC_TYPE_ISO_14443_4:		return (char *)("PICC compliant with ISO/IEC 14443-4");
		case PICC_TYPE_ISO_18092:		return (char *)("PICC compliant with ISO/IEC 18092 (NFC)");
		case PICC_TYPE_MIFARE_MINI:		return (char *)("MIFARE Mini, 320 bytes");
		case PICC_TYPE_MIFARE_1K:		return (char *)("MIFARE 1KB");
		case PICC_TYPE_MIFARE_4K:		return (char *)("MIFARE 4KB");
		case PICC_TYPE_MIFARE_UL:		return (char *)("MIFARE Ultralight or Ultralight C");
		case PICC_TYPE_MIFARE_PLUS:		return (char *)("MIFARE Plus");
		case PICC_TYPE_MIFARE_DESFIRE:	return (char *)("MIFARE DESFire");
		case PICC_TYPE_TNP3XXX:			return (char *)("MIFARE TNP3XXX");
		case PICC_TYPE_NOT_COMPLETE:	return (char *)("SAK indicates UID is not complete.");
		case PICC_TYPE_UNKNOWN:         return (char *)("Unknown type");

...
#define RST522_1 RC522_RST(1)
#define RST522_0 RC522_RST(0)

void RC522_RST(uint8_t status)
{
    if (status)
    {
...
void PcdAntennaTestOn()
{
    //*
    RST522_1;
    delay_ms(15); // 2010.10.09 ???? FOR DEBUG
               //  delay_ms(5)                        ; // 2010.10.09 ???? FOR DEBUG
